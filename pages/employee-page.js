...
export class EmployeePage {
  constructor(page) {
    ...
    this.fridayLocator = page.locator(
      'div.v-list__tile__title:has-text("Friday")'
    );
    this.mcdonaldsLocator = page.locator(
      'a.v-list__tile:has-text("McDonalds")'
    );
    ...
    this.firstDishCardInSecondSection = this.page
      ...
      .locator("div.dish-card")
      .first();
    this.orderButton = this.page.locator(
  ...
  async selectAvailableDay() {
    const unselectedDayLocator = this.page
      .locator("div.v-list__tile")
      .filter({
